...
public class CactusSimulation {
	...
	public int currentHighestPos = 0;
	...
	public int populate(long seed) {
		...
		return this.heightMap[this.currentHighestPos] - this.floorLevel;
	}
	...
	public void generateCactus(Random random, int initialPosX, int initialPosY, int initialPosZ) {
		for(int i = 0; i < 10; i++) {
			...
			for(int j = 0; j < offset; j++) {
				...
				if(this.heightMap[currentHighestPos] < this.heightMap[posMap]) {
